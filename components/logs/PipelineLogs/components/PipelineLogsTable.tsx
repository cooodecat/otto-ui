                ...
                return (
                  ...
                  >
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${statusDisplay.color} ${statusDisplay.bg}`}>
                        {statusDisplay.icon}
                    ...
                    <td className='px-6 py-4'>
                      <div className='space-y-1'>
                        <div className='flex items-center gap-2 text-sm'>
                          ...
                          <span className='font-mono text-gray-600'>{log.commit.sha}</span>
                        </div>
                        <div className='text-sm text-gray-900 max-w-xs'
                             dangerouslySetInnerHTML={{ __html: highlightText(truncateMessage(log.commit.message, 50)) }} />
                        <div className='text-xs text-gray-500'>by {log.commit.author}</div>
                      </div>
                    </td>
                    <td className='px-6 py-4'>
                      <div className='flex items-center gap-2 text-sm text-gray-600'>
