...
import { TestCustomNodeData, CICD_GROUP_COLORS, CICDBlockGroup } from "@/types/cicd-node.types";
    ...
    >
      <div className="space-y-3 text-sm">
        ...
        <div className="grid grid-cols-2 items-center gap-2">
          ...
          <input value={script} onChange={(e)=>setScript(e.target.value)} className="px-2 py-1 border border-gray-300 rounded" placeholder="test" />
        </div>
        <div className="grid grid-cols-2 items-center gap-2">
