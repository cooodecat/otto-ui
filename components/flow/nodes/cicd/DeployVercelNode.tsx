          ...
          <div className="space-y-1">
            {nodeData.projectName && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-gray-800">{nodeData.projectName}</span>
              </div>
            )}
            ...
            {nodeData.buildCommand && (
              <div className="text-xs">
                ...
                <span className="ml-1 font-mono text-gray-800">{nodeData.buildCommand}</span>
              </div>
            )}
            ...
            {nodeData.outputDirectory && (
              <div className="text-xs">
                ...
                <span className="ml-1 font-mono text-gray-800">{nodeData.outputDirectory}</span>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="space-y-3 p-3 bg-gray-50 rounded border">
            ...
            <div className="grid grid-cols-1 gap-2">
              <div className="p-2 bg-white rounded border">
                <div className="text-xs text-gray-600 mb-1">Deployment Settings</div>
                <div className="space-y-1">
            ...
            <div className="pt-2 border-t border-gray-200">
              <div className="text-xs text-gray-600">
                <div>On Success: {nodeData.onSuccess || 'Pipeline complete'}</div>
