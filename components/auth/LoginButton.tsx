...
export default function LoginButton({
  ...
  const baseStyles = "relative inline-flex items-center justify-center gap-3 font-medium transition-all duration-200 rounded-lg";
  ...
  const disabledStyles = "opacity-50 cursor-not-allowed hover:bg-[#24292e] hover:shadow-sm hover:scale-100";
